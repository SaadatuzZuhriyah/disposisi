<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('admin/surat_masuk/edit') ?>" method="post" ecnctype="multipart/form-data" >
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="KETERANGAN" name="keterangan" id="floatingTextarea2" style="height: 100 px" ></textarea>
                    </div>
                    <div class="mb-3">
